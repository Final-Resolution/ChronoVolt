...
/** 定时器0开关和模式及定时时间设置 */
#define TIMER0_ON_OFF ON	/** 定时器0开启 */
#define TIMER0_ON_OFF OFF	/** 定时器0关闭 */
#define TIMER0_MODE	TIMER0_1_MODE0,	/** 定时器0模式0，13位定时器模式 */
#define TIMER0_MODE	TIMER0_1_MODE1,	/** 定时器0模式1，16位定时器 */
#define TIMER0_MODE	TIMER0_1_MODE2,	/** 定时器0模式2，8位自动重装载定时器 */
#define TIMER0_MODE	TIMER0_1_MODE3,	/** 定时器0模式3，两组独立8位定时器 */

/** 定时器1开关和模式及定时时间设置 */
#define TIMER1_ON_OFF ON	/** 定时器1开启 */
#define TIMER1_ON_OFF OFF	/** 定时器1关闭 */
#define TIMER1_MODE	TIMER0_1_MODE0,	/** 定时器1模式0，13位定时器模式 */
#define TIMER1_MODE	TIMER0_1_MODE1,	/** 定时器1模式1，16位定时器 */
#define TIMER1_MODE	TIMER0_1_MODE2,	/** 定时器1模式2，8位自动重装载定时器 */
#define TIMER1_MODE	TIMER0_1_MODE3,	/** 定时器1模式3，两组独立8位定时器 */
 ...
 */
typedef enum {
	TIMER0_1_MODE0,	/** 定时器0和1模式0，13位定时器模式 */
	TIMER0_1_MODE1,	/** 定时器0和1模式1，16位定时器 */
	TIMER0_1_MODE2,	/** 定时器0和1模式2，8位自动重装载定时器 */
	TIMER0_1_MODE3,	/** 定时器0和1模式3，两组独立8位定时器 */
} TIMER0_1_MODE;
